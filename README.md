...
The Linode Stackscript can be found in deploy_scripts/stackscript/rwot_stackscript.sh. You can paste it into a StackScript on Linode and create an instance from it.
